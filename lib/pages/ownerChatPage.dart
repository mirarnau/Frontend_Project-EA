                        ...
                        return Padding(
                          ...
                          child: Container(
                            padding: EdgeInsets.fromLTRB(
                              widget.listMessages![index].senderName == widget.myOwner!.ownerName ? 50.0 : 5.0,
                              4,
                              widget.listMessages![index].senderName != widget.myOwner!.ownerName ? 54.0 : 5.0,
                              4
                              ),
                            child: Align(
                              alignment: (widget.listMessages![index].senderName == widget.myOwner!.ownerName ? Alignment.topRight:Alignment.topLeft),
                              child: Container(
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(20),
                                  color: (widget.listMessages![index].senderName  != widget.myOwner!.ownerName ?Color.fromARGB(255, 143, 143, 143):Color.fromARGB(255, 96, 135, 166)),
                                ),
