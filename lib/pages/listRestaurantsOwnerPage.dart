      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                      child: CardRestaurant(
                          restaurantName:
                              listRestaurants![index].restaurantName,
                          city: listRestaurants![index].city,
                          rating: listRestaurants![index]
                              .rating
                              .last['rating']
                              .toDouble()
                              .toStringAsFixed(1),
                      ...
                      onTap: () {
                        var routes = MaterialPageRoute(
                          builder: (BuildContext context) => InfoRestaurantPage(
            ...
            //   width: 250,
            //   decoration: BoxDecoration(
            //       color: Theme.of(context).hintColor, borderRadius: BorderRadius.circular(20)
            //   ),
            //   child: TextButton(
            //     onPressed: () {
            //       Navigator.push(
