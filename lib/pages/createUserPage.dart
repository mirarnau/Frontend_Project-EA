    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
          ...
          SizedBox(width: 10), 
          Text(translate('login_page.create_user')), 
        ],),
      ),
